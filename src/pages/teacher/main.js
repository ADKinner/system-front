...
import {goLoginPage, goProfilePage, goServerErrorPage, goStudentGroupPage, goStudentTeacherPage} from "../../redirect";
        ...
        return (
            <div className="main_t">
                <div className="bar_p">
                    ...
                    <a onClick={() => goLoginPage(this.props)}>Lessons</a>
                ...
                {this.state.isFindGroup && (
                    <div className="panel_t">
                        ...
                        <div className="find_panel_t">
                            ...
                            <button onClick={() => this.handleSearchGroupButtonClick()} className="btn_l">Search
                            </button>
                        </div>
                    </div>
                )}
