...
import {goLoginPage, goProfilePage, goServerErrorPage, goStudentGroup, goStudentMainPage} from "../../redirect";
        ...
        return (
            <div className="main_group">
                <div className="bar_p">
                    ...
                    <a className="active" onClick={() => goStudentGroup(this.props)}>Group</a>
                    <a onClick={() => goStudentMainPage(this.props)}>Main</a>
                </div>
                <div className="table_panel_group">
                    {!this.state.isEmpty && (
                        <div>
