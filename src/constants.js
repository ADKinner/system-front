...
export const EXAM_GRADE_URL = "/examination-grades";
...
export const SPECIALITY_PARAM = "speciality=";
export const FACULTY_PARAM = "faculty=";
export const CATHEDRA_PARAM = "cathedra=";
